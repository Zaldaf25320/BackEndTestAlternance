...
class User implements UserInterface, PasswordAuthenticatedUserInterface
{
    ...
    /**
     * @var Collection<int, Enterprise>
     */
    #[ORM\OneToMany(targetEntity: Enterprise::class, mappedBy: 'userD')]
    ...
    public function removeEnterprise(Enterprise $enterprise): static
    {
        if ($this->enterprises->removeElement($enterprise)) {
            ...
            if ($enterprise->getUserD() === $this) {
                $enterprise->setUserD(null);
            }
        }
